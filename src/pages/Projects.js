...
const FeaturedProject = ( { type, title, summary, image, link, github } ) => {
    return (
        <article className='w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light transition ease-in-out duration-150 hover:bg-white shadow-2xl dark:shadow-lg dark:shadow-white relative dark:bg-dark dark:text-light dark:hover:border-white p-6'>
            <Link
                href={ link }
                target='_blank'
                className='w-1/2 cursor-pointer overflow-hidden rounded-lg hover:underline'
            >
                <FramerImage
                    src={ image }
                    alt={ title }
            ...
            <div className="w-1/2 flex flex-col items-start justify-between pl-6 h-full">
                <div className="flex-1">
                    ...
                    >
                        <h2 className='my-2 w-full text-left text-2xl font-bold dark:text-teal-500'>{ title }</h2>
                    </Link>
                    <p className='my-2 font-medium text-dark dark:text-blue-500'>{ summary }</p>
                </div>
                <div className="flex items-center mt-4">
                    ...
                    <Link
                        href={ link }
                        target='_blank'
                        className='ml-4 rounded-lg bg-dark text-light px-3 py-2 text-sm font-semibold dark:bg-light dark:text-dark'
                    >
                        Project
                    </Link>
                </div>
